# -*- coding: utf-8 -*-
"""阶段 4: 震 regime 反向避雷扫描

样本 6 段都有, baseline 010坎触发 = +1.23%, 5/6 段 alpha 正
触发: 010 坎 (震 regime 唯一 5/6 段稳的触发卦)

判定:
  ≥4 段 fail (lift ≤ -1) 且 ≤1 段 pass → 强避雷
  ≥4 段 pass (lift ≥ +1) 且 0 段 fail → 强好规律
"""
